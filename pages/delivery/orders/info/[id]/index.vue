  ...
  <div class="cargoBody">
    <div class="deliveryInfoHeading" style="margin-bottom: 64px">
      <div class="deliveryInfoHeadingTitle CargoHeadingTitle" style="">
        Заявка {{ data.cargo_order ? `#${data.cargo_order.idx}` : null }}
      </div>
      <div class="deliveryInfoHeadingDesc CargoHeadingDesc">
        <!--        Найдите надежного отправителя легко и быстро, заработав!-->
      </div>
    </div>
    <div class="deliveryBodyCargsItemInfo" style="margin-bottom: 32px">
      <div class="deliveryBodyCargsItemInfoWrapper" style="display: flex; gap: 8px;">
        <div class="cargsItemInfoDate CargoWidgetBlock" style="" v-if="data.cargo_order.cargo_deliv_start_at !== null">
          <div class="cargsItemInfoDateWrapper CargoWidgetBlockWrapper">
            <div class="CargoWidgetBlockValue">
              Дата: {{
                data.cargo_order.cargo_deliv_start_at ? getFormatDate(data.cargo_order.cargo_deliv_start_at) : null
              }}
            </div>
        ...
        <div class="cargsItemInfoWeight CargoWidgetBlock" style="" v-if="data.cargo_order.cargo_inf_wht !== null">
          <div class="cargsItemInfoWeightWrapper CargoWidgetBlockWrapper">
            <div class="CargoWidgetBlockValue">
              Вес груза: {{ data.cargo_order.cargo_inf_wht ? data.cargo_order.cargo_inf_wht : 0 }}
            </div>
            <div class="CargoWidgetBlockIcon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="cargsItemInfoSize CargoWidgetBlock" v-if="data.cargo_order.cargo_inf_size !== null">
          <div class="cargsItemInfoSizeWrapper CargoWidgetBlockWrapper">
            <div class="CargoWidgetBlockValue">
              Объем груза: {{ data.cargo_order.cargo_inf_size ? data.cargo_order.cargo_inf_size : 0 }}
            </div>
            <div class="CargoWidgetBlockIcon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div class="deliveryBodyOfferInfoBlock" style="margin-bottom: 14px;">
            <div class="deliveryBodyCargsItem" v-if="data.cargo_order !== null"
              ...
              <div class="deliveryBodyCargsItemBlock"
                ...
                <!--                <div class="deliveryBodyCargsItemInfo"></div>-->
                <div class="deliveryBodyCargsItemBody">
                  <div class="cargsItemBodyRoute">
                    <div class="cargsItemBodyRouteWrapper">
                      <div class="cargsItemBodyRouteTitle" v-if="data.cargo_order.cargo_type">
                        Тип груза:
                      </div>
                      <div class="cargsItemBodyRouteValue">
                        {{ data.cargo_order.cargo_type }}
                      </div>
                    </div>
                  </div>
                  <div class="cragsItemBodyType" style="">
                    <div class="cragsItemBodyTypeWrapper">
                      ...
                      <div class="cragsItemBodyTypeValue">
                        {{ data.cargo_order.cargo_inf_from }} — {{ data.cargo_order.cargo_inf_to }}
                      </div>
                    </div>
                ...
                <div class="deliveryBodyCargsItemDesc">
                  <div class="cargsItemDescHeading">
                    ...
                    <div class="cargsItemDescHeadingText">
                      {{ data.cargo_order.description }}
                    </div>
                  </div>
                </div>
                <div class="deliveryBodyCargsItemAction">
                  <div class="deliveryBodyCargsItemActionWrapper"
                       style="display: flex; flex-flow: row wrap; gap: 0 10px;">
                    <div class="deliveryBodyCargsItemActionBtn __Active">
                      <button @click="router.push({name: 'delivery-offers-info-id',params: {
                    id: data.cargo_order.idx
                  }})">
...
<path
    ...
    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12.5 17L11.5 13L7.5 12L16.5 8L12.5 17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round"/>
</svg>

                    </span>
                    <span class="itemActionBtnTitle">Оплатить доставку</span>
...
<path d="M12.5 17L11.5 13L7.5 12L16.5 8L12.5 17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round"/>
                    ...
                    <span class="itemActionBtnTitle">Отмена заявки</span>
...
<path d="M12.5 17L11.5 13L7.5 12L16.5 8L12.5 17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round"/>
                    ...
                    <span class="itemActionBtnTitle">Апелляция</span>
...
<path d="M12.5 17L11.5 13L7.5 12L16.5 8L12.5 17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round"/>
                    ...
                    <span class="itemActionBtnTitle">Заблокировать</span>
...
.deliveryBodyCargsItem .deliveryBodyCargsItemBlock .deliveryBodyCargsItemAction .deliveryBodyCargsItemActionBtn.__Active button {
...
.deliveryBodyCargsItem .deliveryBodyCargsItemBlock .deliveryBodyCargsItemAction .deliveryBodyCargsItemActionBtn.__Active button .itemActionBtnTitle {
  color: #fff;
}

.deliveryBodyCargsItem .deliveryBodyCargsItemBlock .deliveryBodyCargsItemAction .deliveryBodyCargsItemActionBtn.__Active button .itemActionBtnIcon {
  color: #fff;
}
</style>