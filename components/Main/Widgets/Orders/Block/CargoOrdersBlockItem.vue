...
function createOrViewOffer(order: any) {
...
async function onMouseEnterToBlock(status: boolean) {
  setTimeout(() => {
    data.block.btn.active = status
  }, 200);
}

onMounted(async () => {
  data.block.btn.active = props.activeBtn;
  //
    ...
    <div class="deliveryBodyCargsItemBlock"
      ...
      <div class="deliveryBodyCargsItemBody">
        <div class="cargsItemBodyRoute">
          <div class="cargsItemBodyRouteWrapper">
            <div class="cargsItemBodyRouteTitle" v-if="order.type_cargo">
              Тип груза:
            </div>
      ...
      <div class="deliveryBodyCargsItemAction">
        <div class="deliveryBodyCargsItemActionBtn">
          <button @click="createOrViewOffer(order)" v-if="data.block.btn.active">
